...
class FirebaseConfig {
  ...
  static Future<void> initialize() async {
    try {
      ...
      final String jsonString = await rootBundle.loadString('assets/google-services.json');
      ...
      print('Firebase Config loaded - Web Client ID: $_webClientId, Project ID: $_projectId');
    } catch (e) {
      print('Error loading Firebase config: $e');
      // Fallback to default values if needed
      _webClientId = '84702649653-6agk4ck0iest2pd23r3janelu0lffaj4.apps.googleusercontent.com';
      _projectId = 'splitemate-app';
    }
  }
  
  static String get webClientId {
    if (_webClientId == null) {
      throw Exception('FirebaseConfig not initialized. Call FirebaseConfig.initialize() first.');
    }
    return _webClientId!;
  }
