...
class _PersonalTransactionPageState extends State<PersonalTransactionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<LedgersCubit, List<Ledger>>(builder: (__, ledgers) {
      ...
      if (this.ledgers.isEmpty) return const EmptyTransactions(isPersonal: true,);
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            ...
            onTap: () async {
              ...
              await widget.router
                  .onShowTransactionThread(context, demoUsers, widget.me, item, LedgerType.individual);
              if (!mounted) return;
              await cubit.ledgers(LedgerType.individual);
            },
          );
        },
      ),
