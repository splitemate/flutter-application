...
class PersonalTransactionPage extends StatefulWidget {
  final CurrentUser me;
  final IHomeRouter router;

  const PersonalTransactionPage(
      {super.key, required this.me, required this.router});

  @override
  State<PersonalTransactionPage> createState() =>
      _PersonalTransactionPageState();
}

class _PersonalTransactionPageState extends State<PersonalTransactionPage> {
  var ledgers = [];
        ...
        child: InkWell(
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => _ChatViewScreen(
                  me: widget.me,
                  ledger: item,
                  size: size,
                ),
          ...
          children: [
            ...
            ChatViewHeader(
              ...
              trailingWidget: IconButton(
                icon: const Icon(Icons.call, color: kWhiteColor),
                onPressed: () {
            ...
            Expanded(
              child: TransactionListView(
                ...
                me: widget.me,
                size: size,
                ledgerType: LedgerType.individual,
              ),
            ),
            ...
            ActionButtons(
              size: size,
              leftButtonText: 'DEVANA',
              rightButtonText: 'LEVANA',
              onLeftButtonPressed: () {
                // TODO: Implement Devana (I owe) functionality
              },
